...
export default class Declaracion extends Instruccion {
    ...
    interpretar(arbol: Arbol, tabla: TablaSimbolo) {
        ...
        if (this.tipoDato.getTipo() != this.valor.tipoDato.getTipo()) {
            return new Errores("Semantico", `Error de tipo en la declaracion de la variable ${this.id}, esperado ${this.tipoDato.getTipo()} pero obtenido ${this.valor.tipoDato.getTipo()}`, this.linea, this.columna);
        }
